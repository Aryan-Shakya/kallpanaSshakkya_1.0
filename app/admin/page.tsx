                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                const finalVal = match ? match[1] : val;
                                                setEditingPost({ ...editingPost, youtubeVideoId: finalVal });
                                            }}
                                            className="w-full px-4 py-2 rounded-lg border border-[#CBD5E1] focus:ring-2 focus:ring-[#52796F] outline-none"
                                            placeholder="Paste ID or full URL here"
                                        />
                                        <p className="text-xs text-[#64748B] mt-1">
                                            The code at the end of the URL: https://www.youtube.com/watch?v=<b>dQw4w9WgXcQ</b>
                                        </p>
                                    </div>
                                </div>
